<?php
/*
Plugin Name: Ushahidi Press
Plugin URI: http://dkfactor.com/2010/11/02/ushahidipress/
Description: Embed Ushahidi/CrowdMap reports with maps in your Wordpress Blog
Author: David Kobia
Version: 0.5
...
class Ushahidi_Embed {
	...
	{
		$map_id = substr(md5(microtime()), 0, 8);;
		...
		$height = ((int) $attr["height"]) ? $attr["height"]."px" : "350px";
		$width = ((int) $attr["width"]) ? $attr["width"]."px" : "350px";
			...
			if ($report)
			{
				...
				<script type="text/javascript">
					jQuery(function() {
						...
						var map = new google.maps.Map(document.getElementById("ushahidi_map_<?php echo $map_id;?>"), myOptions);
				...
				<div class="ushahidi_map_wrapper">
					<div class="ushahidi_map" id="ushahidi_map_<?php echo $map_id;?>" style="height:<?php echo $height;?>;width:<?php echo $width;?>"></div>
					<div class="ushahidi_map_caption" style="width:<?php echo $width;?>"><a href="<?php echo $report['url']; ?>" target="_blank"><?php echo $report['incident_title']; ?></a></div>
				</div>
				<?php
			}
		}
